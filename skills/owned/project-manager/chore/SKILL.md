...
- **Feature** — a new **function of the product or network** (a capability or behaviour users get). Runs the full development flow (`orchestrating-subagents` maps the phases, agents, and skills).
