...
# ── guard-git: ask — state mutation ──
bash_case ask 'git commit -m "feat: x"'
bash_case ask 'git commit --amend --no-edit'
bash_case ask 'git rebase -i HEAD~3'
bash_case ask 'git cherry-pick abc123'
bash_case ask 'git reset --hard HEAD~1'
bash_case ask 'git clean -fd'
bash_case ask 'git tag v1.0'
bash_case ask 'git tag -d v1.0'
...
# ── guard-git: allow — everyday work stays frictionless ──
