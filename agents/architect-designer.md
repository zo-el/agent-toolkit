...
- **Ground external contracts in real docs, not memory.** When a design leans on a third-party library or API, confirm its real surface through the **Context7** MCP before writing the contract.
